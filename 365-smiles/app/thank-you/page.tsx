...
export default function ThankYou() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (imageFile) {
      ...
      const { data: uploadData, error: uploadError } =
        await supabase.storage
          .from('donation-screenshots') // Fixed: was 'public-donations' (Issue #12)
    ...
    setUploading(false);
    setSuccess(true);
    toast.success('Your details have been saved! Thank you for donating.');
    ...
    <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-gray-950 text-white flex flex-col items-center justify-center px-4 py-16">
      {!success ? (
        ...
        >
          <div className="flex flex-col items-center text-center mb-6">
            ...
            <p className="mt-2 text-white/70 max-w-prose">
              Please fill your details to show up on our website. This helps
              us acknowledge your contribution and inspire others.
            </p>
          </div>

          {error && (
            <p
              className="mb-4 text-red-400 font-semibold text-center"
              role="alert"
            >
              {error}
            </p>
            ...
            {previewUrl && (
              <div className="mt-3 flex items-center gap-4">
                ...
                <p className="text-sm text-white/60">
                  We may feature this on our donors gallery.
                </p>
              </div>
            )}
          </div>
          ...
          <p className="text-xs text-white/50 mb-4">
            By submitting, you agree to display your name, donated amount
            and optional message on our public donors page.
          </p>
        ...
        <div className="text-center max-w-md px-4">
          ...
          <h2 className="text-4xl font-extrabold mb-3 text-pink-400">
            Thank You!
          </h2>
