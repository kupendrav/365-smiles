...
export function DailyNeedsClient() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    formData.append("type", "daily-needs");
    ...
    <div className="relative min-h-screen w-full overflow-hidden bg-black text-white">
      ...
      <main className="relative z-10 max-w-4xl mx-auto p-6 mt-24 sm:mt-32 text-center">
        <h1 className="text-4xl md:text-6xl font-extrabold mb-6">
            Support Daily Needs with 365 Smiles
        </h1>
        <p className="text-lg md:text-xl max-w-3xl mx-auto leading-relaxed mb-12">
          365 Smiles ensures vulnerable families, seniors, and differently‑abled individuals receive daily essentials—fresh meals, ration kits, hygiene supplies, and seasonal clothing—when they need them most.
           Every contribution keeps kitchens running, restores dignity through basic care, and brings immediate relief to households across India.
        </p>
