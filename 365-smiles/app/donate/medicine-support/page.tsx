    ...
    <div className="relative min-h-screen w-full overflow-hidden bg-black text-white">
      ...
      <main className="relative z-10 max-w-4xl mx-auto p-6 mt-24 sm:mt-32 text-center">
        <h1 className="text-4xl md:text-6xl font-extrabold mb-6">
            Support Medicine Support with 365 Smiles
        </h1>
        <p className="text-lg md:text-xl max-w-3xl mx-auto leading-relaxed mb-12">
         365 Smiles connects vulnerable patients to essential healthcare—doctor consultations, diagnostics, long‑term medicines, assistive devices, and emergency care—so treatment isn’t delayed by cost or access. Every contribution funds timely checkups, critical prescriptions, and compassionate follow‑up, safeguarding health and dignity for seniors, children, and differently‑abled individuals across India.
        </p>
