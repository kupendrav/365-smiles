...
export default function Home() {
  ...
  // Mouse "love bubbles" — use ref to avoid unbounded state growth (Issue #20)
  ...
  return (
    <div className="relative min-h-screen w-full bg-gradient-to-b from-gray-950 via-gray-900 to-black text-white overflow-x-hidden page-shell">
      ...
      {/* Navbar */}
      <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-black/55 border-b border-white/10">
      ...
      <section
        id="hero"
        className="relative min-h-[100svh] w-full flex items-stretch"
      >
        <video
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 sm:px-6 py-24 lg:py-32 w-full">
          ...
          >
            Support orphans, elders, and differently-abled people—365 days a
            year.{' '}
          </motion.p>
          <motion.div
            ...
            {donors.slice(0, 4).map((donor, idx) => (
              <motion.div
                ...
                whileHover={{
                  scale: 1.04,
                  boxShadow:
                    '0 0 0 4px #ec4899, 0 8px 32px 0 #ec489980',
                  borderColor: '#ec4899',
                }}
                className={`w-full sm:w-80 md:w-96 max-w-[420px] border border-pink-500/30 card-gradient p-6 rounded-2xl shadow-xl flex items-center ${idx % 2 === 1 ? 'flex-row-reverse' : 'flex-row'} gap-5 transition-all duration-300 relative overflow-hidden`}
              >
      ...
      {/* Causes: three fullscreen sections */}
      <section
        id="causes"
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 grid md:grid-cols-2 gap-14 md:gap-16 items-start">
          ...
          <div>
            ...
            <p className="mt-4 text-white/85 text-lg">
              Books, tuition, devices, and mentoring that unlock learning
              pathways for children and youth.
            </p>
            <ul className="mt-6 space-y-2 text-white/85">
              <li>
                • Scholarships and exam fees support continuity of learning.
              </li>
          ...
          <div>
            ...
            <p className="mt-4 text-white/85 text-lg">
              Nutritious meals and essentials for orphans, the elderly, and
          ...
          <div>
            ...
            <p className="mt-4 text-white/85 text-lg">
              Medical checkups, medicines, assistive devices, and critical
              healthcare support.
            </p>
            <ul className="mt-6 space-y-2 text-white/85">
        ...
        <div className="p-0 flex flex-col md:flex-row items-center gap-6">
          <div className="flex-1">
            ...
            <p className="text-white/80 text-sm md:text-base leading-relaxed">
              Certificate earned from the{' '}
              <span className="font-semibold">
                Department of Social Justice and Empowerment, Government of
                India
              </span>
              .
            </p>
            <a
              href="/pledge-certificate.pdf"
              target="_blank"
              rel="noreferrer"
              className="inline-block mt-4 text-sm font-medium px-4 py-2 rounded-lg bg-pink-600 hover:bg-pink-700 transition"
            >
              View Certificate
            </a>
          </div>
          <div className="w-full md:w-56 aspect-[4/3] overflow-hidden">
            <Image
              src="/pledge-certificate-1.png"
              alt="Pledge Certificate from Department of Social Justice"
              width={448}
              height={336}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="mt-4 text-white/85">
              A community-led initiative enabling everyday celebrations to fund
              essential care across India—one day at a time.{' '}
            </p>
            <p className="mt-3 text-white/85">
              Through verified partners, transparent tracking, and local
              delivery, donations reach those in need with dignity.{' '}
            </p>
      ...
      <section
        id="faqs"
        className="py-16 md:py-20 bg-gradient-to-b from-gray-950 to-black"
      >
          ...
          <div className="divide-y divide-white/10 rounded-2xl border border-white/10 overflow-hidden">
            <details className="group open:bg-white/5 p-5">
              ...
              <p className="mt-3 text-white/80">
                Donations are allocated to verified programs across education,
                daily needs, and medical support with transparent records.
              </p>
            </details>
            <details className="group open:bg-white/5 p-5">
              <summary className="flex cursor-pointer list-none items-center justify-between">
              ...
              <p className="mt-3 text-white/80">
                Yes, dedicate birthdays, anniversaries, or memorial days; we
                schedule impact activities on that date.
              </p>
            </details>
            <details className="group open:bg-white/5 p-5">
              <summary className="flex cursor-pointer list-none items-center justify-between">
              ...
              <p className="mt-3 text-white/80">
                Digital receipts and impact summaries are shared
                post-disbursement.
              </p>
            </details>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2 text-white/80">
              <li>
                <a
                  href="mailto:365smilestrust@gmail.com"
                  className="hover:text-white"
                >
                  365smilestrust@gmail.com
                </a>
              </li>
              <li>
                <a href="tel:+919740221999" className="hover:text-white">
                  +91 9740221999
                </a>
              </li>
              <li>
                <a
                  href="https://maps.app.goo.gl/BXkaJ1rM88RF6as79"
                  target="_blank"
                  className="hover:text-white"
                  rel="noreferrer"
                >
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2 text-white/80">
              <li>
                <a
                  href="https://instagram.com/365smiles"
                  target="_blank"
              ...
              <li>
                <a
                  href="https://linkedin.com/company/365smiles"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-white"
                >
              ...
              <li>
                <a
                  href="https://youtube.com/@365smiles"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-white"
                >
