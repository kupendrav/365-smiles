        ...
        <div className="mx-auto max-w-xl rounded-2xl border border-white/30 bg-white/50 backdrop-blur-xl shadow-xl p-6 md:p-8">
          <form onSubmit={handleSubmit} className="space-y-4">
            <label className="block">
              <span className="block text-sm mb-1 text-gray-800">Home/Trust Name</span>
              <input
                type="text"
            ...
            <label className="block">
              <span className="block text-sm mb-1 text-gray-800">Amount Donated (INR)</span>
              <input
                type="number"
                min={1}
            ...
            <label className="block">
              <span className="block text-sm mb-1 text-gray-800">Date</span>
              <input
                type="date"
                value={date}
            ...
            <label className="block">
              <span className="block text-sm mb-1 text-gray-800">Notes (optional)</span>
              <textarea
                placeholder="Notes"
                value={notes}
